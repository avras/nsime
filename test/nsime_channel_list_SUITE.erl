...
test_start_stop(_) ->
    ...
    ?assertEqual(nsime_channel_list:get_channel_list(), []),
...
test_add_delete(_) ->
    ...
    ChannelList = nsime_channel_list:get_channel_list(),
    ?assert(lists:member(ChannelPid1, ChannelList)),
    ?assert(lists:member(ChannelPid2, ChannelList)),

    ?assertEqual(nsime_channel_list:delete(ChannelPid1), ok),
    ?assertEqual(nsime_channel_list:delete(ChannelPid1), ok),
    ChannelList1 = nsime_channel_list:get_channel_list(),
    ?assertNot(lists:member(ChannelPid1, ChannelList1)),
    ?assert(lists:member(ChannelPid2, ChannelList1)),
